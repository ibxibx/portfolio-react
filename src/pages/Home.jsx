...
const Home = () => {
  ...
  const projects = [
    {
      ...
      description:
        "A full-stack SaaS platform that analyzes workplace workflows and delivers AI readiness scores, automation ROI projections, agentification roadmaps, and risk flags — across Individual, Team, and Company contexts. Ships live-progress analysis via SSE streaming, full EN/DE localization, a GDPR/TTDSG-compliant consent flow, and an admin analytics dashboard powered by PostHog and first-party tracking. Built with Next.js, FastAPI, Claude, and Turso (persistent cloud database) on Render.",
      technologies: [
        "Next.js",
        "TypeScript",
        "Python",
  ...
  const Section = React.forwardRef(({ id, children }, ref) => (
    <motion.section
      ref={ref}
      id={id}
      className="relative w-full pt-1 pb-32 scroll-mt-32"
      initial={{ opacity: 0 }}
          ...
          <div className="w-full max-w-[1000px] mx-auto grid grid-cols-1 md:grid-cols-[1fr] lg:grid-cols-[600px_350px] gap-6">
                ...
                <div className="space-y-6 text-sm text-white/80">
                  ...
                  <div className="space-y-2">
                    ...
                    <p>
                      ...
                      Working closely with software engineers and immersing myself in
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <a
                  href={resumePDF}
                  download="Ian Baumeister - Full Stack Engineer - Resume"
