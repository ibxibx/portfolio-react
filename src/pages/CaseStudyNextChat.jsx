        ...
        <div className="min-h-full flex flex-col items-center p-4 sm:p-6 md:p-8">
          ...
          <div className="flex justify-center">
            <div className="max-w-[1000px] w-full space-y-16">
              {/* Hero Section */}
              <section className="w-full space-y-8 flex flex-col items-center">
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5 }}
                ...
                <div className="prose prose-lg prose-invert max-w-none font-['PP_Neue_Machina']">
                  <p>
                    ...
                    apart from the largest and most complex project which was
                    the MyMDB app, I particularly enjoyed working on my NextChat
                    - React Native mobile app for chatting.
                  </p>
                  <p>
                    The objective was to build a chat app for mobile devices
                    using React Native. The app will provide users with a chat
                    interface and options to share images and their location.
                  </p>
                  <br />
                  <p>
                    It's quite a feature-rich app that I built and tested with
                    my tutor and mentor. The basic code snippets and parts were
                    provided along the course set of lessons that encompassed
                    the development of this app to start with and slowly enrich
                    the app step by step with all the following features.
                  </p>
                </div>
              </section>
            </div>
              ...
              <div className="space-y-8 font-['PP_Neue_Machina']">
                <div>
                  ...
                  <p>
                    ...
                    the app and then use it for further testing and development,
                    for some reason the Expo app wouldn't render the app on my
                    phone to test and see the app code at work. The recommended
                    older version of Node 16.19.0 did not work with Expo on my
                    android phone.
                  </p>
                  <br />
                  <p>
                    Using Node 16.19.0, I tried many older versions of the Expo
                    app, to get a working combo, installing all these versions
                    (up to 3 years old) one after the other but all these
                    efforts did not render the app on Expo.
                  </p>
                </div>
              </div>
              <div>
                ...
                <br />
                <p className="text-sm text-center text-gray-400">
                  App Testing: Start Screen, Chat Screen, Chat Screen
                </p>
              </div>
            </div>
              ...
              <div className="space-y-8 font-['PP_Neue_Machina']">
                <div>
                  ...
                  <p>
                    ...
                    Screen background) along with the user id name
                    authentication.
                  </p>
                  <p>
                    After using the IPv4 address as the IP address to render the
                    app on my mobile - which didn't work either - I found that
                    the Expo Snack Box online had the right settings and
                    environment to test the app. I used the sandbox/snack until
                    the integration with Google Firebase came into play! The
                    Expo Snack was a short time solution – it did not work at
                    all with Google Firebase with all the further tweaking - it
                    didn't throw an error, but it also didn't render the app in
                    the preview panel - meaning Expo Snack and Google Firebase
                    have a has a compatibility issue.
                  </p>
                  <p>
                    Android Studio played a huge role here as an emulator, where
                    I was able to render the app and test it on Expo's local
              ...
              <div className="space-y-8 font-['PP_Neue_Machina']">
                <div>
                  ...
                  <p>
                    ...
                    the Firebase drive. It was great to see it working
                    seamlessly.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-8 font-['PP_Neue_Machina']">
                <div>
                  ...
                  <p>
                    ...
                    mobile chat layout, which is recommended for successful app
                    adoption. I added the second screen, Chat.js, which logs the
                    username and displays the background colour chosen on the
                    intro screen. Later, I've added the offline mode handling
                    functionality and the display of the messages without the
                    messaging bar when the internet connection is interrupted or
                    lost.
                  </p>
                  <p>
...
const uploadAndSendImage = async (imageURI) => {
  try {
    ...
    Alert.alert("Error uploading image", error.message);
              ...
              <div className="space-y-8 font-['PP_Neue_Machina']">
                <div>
                  ...
                  <p>
                    ...
                    but the same story - as with the mobile - didn't work, but I
                    tried every possible way known to me at the time to create
                    and showcase a live chat. Only Android Studio rendered my
                    Expo app correctly and fully.
                  </p>
                </div>
              </div>
              {/*image space*/}
              ...
              <div className="space-y-8 font-['PP_Neue_Machina']">
                <div>
                  ...
                  <p>
                    ...
                    time - as my mentor Stephen was running my app code locally
                    on his PC in Android Studio during our Skype call - and I
                    was running the same code on my PC, we even laughed - he
                    thought he was testing the app alone on the call and asked -
                    what are these messages appearing - I replied - no way - are
                    we chatting live now!? My app (with the entire tech in it)
                    facilitated a live chat between 2 continents - my chin
                    dropped...to my surprise the app felt 'alive'! But then I
                    realised that if the Google Firebase stores and displays the
                    messages from all the active users - it should display all
                    messages in real time as well, even though the app was
                    running on 2 local servers on 2 different continents... the
                    chat still worked for us. It was fun and a truly memorable
                    moment. The power of technology never ceases to surprise,
                    inspire and move me!
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              <div className="space-y-8 font-['PP_Neue_Machina']">
                <h2 className="text-3xl font-['PP_Object_Sans']">Branding</h2>
                <p>
            ...
            <div className="space-y-8 font-['PP_Object_Sans']">
              <h2 className="text-3xl font-['PP_Object_Sans']">
