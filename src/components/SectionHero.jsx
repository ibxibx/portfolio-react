...
const SectionHero = ({ title = "Junior Developer", subtitle = "Building modern web applications" }) => {
  return (
    <section className="hero relative flex items-center justify-center" style={{ height: 'calc(100dvh - 6rem)' }}>
